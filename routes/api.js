...
const listkey = ["itsukiwangy", "zeeoneofc"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'itsukiwangy') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
	...
	if (apikeyInput != 'itsukiwangy')  return res.json(loghandler.invalidKey)
